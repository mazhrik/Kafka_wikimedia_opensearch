...
public class consumerdemo_cooperative_assinger {
        private static final Logger log =LoggerFactory.getLogger(consumerdemo_cooperative_assinger.class.getSimpleName());
...
//        connect to coducter playground
        ...
        properties.setProperty("partition.assingnment.strategy", CooperativeStickyAssignor.class.getName());
